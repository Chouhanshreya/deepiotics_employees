...
export const declareBestEmployee = (userId, department, type = 'manual') => api.post('/admin/best-employee', { userId, department: department || undefined, type });
export const declareBestTL = (userId, department, type = 'manual') => api.post('/admin/best-tl', { userId, department: department || undefined, type });
